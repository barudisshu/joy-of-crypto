...
create_keys() {
   ...
   keytool -genkeypair -alias root -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-root' \
   ...
   keytool -genkeypair -alias ca -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-ca' \
   ...
   keytool -genkeypair -alias caalt -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-ca' \
        -ext BC=1 -validity $VALIDITY -keypass $TRUST_STORE_PWD -keystore $TRUST_STORE -storepass $TRUST_STORE_PWD
   ...
   keytool -genkeypair -alias server -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-server' \
   ...
   keytool -keystore $KEY_STORE -storepass $KEY_STORE_PWD -certreq -alias server | \
      ...
      'san=dns:my.test.server,dns:info.galudisu.io,ip:35.185.40.182,dns:localhost,ip:127.0.0.1,ip:::1' \
   ...
   keytool -genkeypair -alias serverrsa -keyalg RSA -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-server-rsa' \
        -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $KEY_STORE -storepass $KEY_STORE_PWD -storetype $DEFAULT_STORE_TYPE
   keytool -keystore $KEY_STORE -storepass $KEY_STORE_PWD -certreq -alias serverrsa | \
      ...
      -ext 'san=dns:localhost,ip:127.0.0.1,ip:::1,dns:info.galudisu.io,ip:35.185.40.182' \
   ...
   keytool -genkeypair -alias ca2 -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-ca2' \
   ...
   keytool -genkeypair -alias serverlarge -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-serverlarge' \
   ...
   keytool -genkeypair -alias carsa -keyalg RSA -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-ca-rsa' \
        -ext BC=0 -validity $VALIDITY -keypass $TRUST_STORE_PWD -keystore $TRUST_STORE -storepass $TRUST_STORE_PWD
   ...
   keytool -genkeypair -alias servercarsa -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-server-ca-rsa' \
        -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $KEY_STORE -storepass $KEY_STORE_PWD
   ...
   keytool -genkeypair -alias client -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-client' \
        -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $KEY_STORE -storepass $KEY_STORE_PWD
   ...
   keytool -genkeypair -alias clientexpired -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-client-expired' \
   ...
   keytool -genkeypair -alias clientrsa -keyalg RSA -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-client-rsa' \
        -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $KEY_STORE -storepass $KEY_STORE_PWD
   ...
   keytool -genkeypair -alias self -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-self' \
   ...
   keytool -genkeypair -alias nosigning -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-nosigning' \
   ...
   keytool -genkeypair -alias clientext -keyalg EC -groupname secp256r1 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-clientext' \
        -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $KEY_STORE -storepass $KEY_STORE_PWD
   ...
   keytool -genkeypair -alias clienteddsa -keyalg Ed25519 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-client-eddsa' \
   ...
   if [ $? -eq 0 ] ; then
      ...
      keytool -genkeypair -alias caeddsa -keyalg Ed25519 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-ca-eddsa' \
      ...
      keytool -genkeypair -alias servereddsa -keyalg Ed25519 -dname 'C=CN,L=Guangzhou,O=Galudisu IoT,OU=Galudisu,CN=cf-server-eddsa' \
           -validity $VALIDITY -keypass $KEY_STORE_PWD -keystore $EDDSA_KEY_STORE -storepass $KEY_STORE_PWD -storetype $DEFAULT_STORE_TYPE
...
export_pem() {
   ...
   if [ $? -eq 0 ] ; then
      ...
      openssl pkcs12 -legacy -in $SERVER_KEY_STORE_P12 -passin pass:$KEY_STORE_PWD -nodes -out $SERVER_KEY_STORE_PEM
      openssl pkcs12 -legacy -in $SERVER_LARGE_KEY_STORE_P12 -passin pass:$KEY_STORE_PWD -nodes -out $SERVER_LARGE_KEY_STORE_PEM
      openssl pkcs12 -legacy -in $SERVER_RSA_KEY_STORE_P12 -passin pass:$KEY_STORE_PWD -nodes -out $SERVER_RSA_KEY_STORE_PEM
      openssl pkcs12 -legacy -in $SERVER_CA_RSA_KEY_STORE_P12 -passin pass:$KEY_STORE_PWD -nodes -out $SERVER_CA_RSA_KEY_STORE_PEM
      if [ -s $SERVER_EDDSA_KEY_STORE_P12 ] ; then
         openssl pkcs12 -legacy -in $SERVER_EDDSA_KEY_STORE_P12 -passin pass:$KEY_STORE_PWD -nodes -out $SERVER_EDDSA_KEY_STORE_PEM
      fi
      openssl pkcs12 -legacy -in $CLIENT_KEY_STORE_P12 -passin pass:$KEY_STORE_PWD -nodes -out $CLIENT_KEY_STORE_PEM
      openssl pkcs12 -legacy -in $CLIENT_RSA_KEY_STORE_P12 -passin pass:$KEY_STORE_PWD -nodes -out $CLIENT_RSA_KEY_STORE_PEM
      if [ -s $SERVER_EDDSA_KEY_STORE_P12 ] ; then
         openssl pkcs12 -legacy -in $CLIENT_EDDSA_KEY_STORE_P12 -passin pass:$KEY_STORE_PWD -nodes -out $CLIENT_EDDSA_KEY_STORE_PEM
      fi
      openssl pkcs12 -legacy -in $ROOT_TRUST_STORE_P12 -passin pass:$TRUST_STORE_PWD -nokeys -out $ROOT_TRUST_STORE_PEM
      openssl pkcs12 -legacy -in $CA_TRUST_STORE_P12 -passin pass:$TRUST_STORE_PWD -nokeys -out $CA_TRUST_STORE_PEM
      openssl pkcs12 -legacy -in $CA_RSA_TRUST_STORE_P12 -passin pass:$TRUST_STORE_PWD -nokeys -out $CA_RSA_TRUST_STORE_PEM
      if [ -s $CA_EDDSA_TRUST_STORE_P12 ] ; then
         openssl pkcs12 -legacy -in $CA_EDDSA_TRUST_STORE_P12 -passin pass:$TRUST_STORE_PWD -nodes -out $CA_EDDSA_TRUST_STORE_PEM
      fi
      openssl pkcs12 -legacy -in $TRUST_STORE_P12 -passin pass:$TRUST_STORE_PWD -nokeys -out $TRUST_STORE_PEM
